...
The board is powered from the Pi Pico USB connection. For powering the experiment circuits, Jumpers can be configured for 0 and +3.3V, 0 and +5V or -5V and +5V power using an on board isolated 5V DC-DC generator. Pi Pico microcontroller internal 12 bit ADC along with an external dual 12 bit DAC provide some level of data acquisition measurement capability for experiments.
